...
import com.demo.db.demo_db.dtos.UserDto;
import com.demo.db.demo_db.entity.Roles;

//IMPORT RELATIONS

import com.demo.db.demo_db.service.SanphamService;

import com.demo.db.demo_db.service.RolesService;
...
//CRUD METHODS
	...
	public ResponseEntity<UserDto> insert(@RequestBody User obj) {
		...
		//external relation sanpham
		if (obj.getSanpham() != null && !obj.getSanpham().isEmpty())
			obj.getSanpham().forEach(sanpham -> sanphamService.insert(sanpham));
	...
	public ResponseEntity<Void> delete(@PathVariable("id") Long id) {
		...
		//external relation sanpham
		if (userSelected.getSanpham() != null && !userSelected.getSanpham().isEmpty()) {
			userSelected.getSanpham().forEach(sanpham -> sanphamService.delete(sanpham.get_id()));
		}
